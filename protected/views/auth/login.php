                ...
                <div class="col-sm-8 offset-sm-2 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 text-center">
                    ...
                    <div class="rounded bg-white shadow p-5">
                        <form method = "post">
                            ...
                            <button type="submit" id="login" name = "login" class="btn btn-primary submit_btn w-100 my-4" <?php echo Yii::app()->createUrl('/auth/login'); ?>>Login</button>
                        </form>
                        <form method="get">
                            <button type="submit" class="btn btn-light" formaction="<?php echo Yii::app()->createUrl('/auth/forgot'); ?>"> Forgot Password? </button>
                        </form>
                        <br>
                        <div>
                            <form class="rounded bg-white" method="post">
                                <div class="fw-normal text-muted mb-3">
                                    New User?&nbsp;&nbsp;&nbsp;<button class="btn btn-outline-primary" formaction="<?php echo Yii::app()->createUrl('/auth/signup'); ?>">Sign Up</button>
                                </div>
                            </form>
                        </div>
                    </div>
